# ABBooking — AI Booking System for Small Businesses

An automated booking system built for Norwegian small businesses. 
...
- Gmail OAuth** — Email confirmations
- Twilio — SMS reminders
- Nginx + Docker — Server deployment
